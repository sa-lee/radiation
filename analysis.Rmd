---
title: "Data in Brief"
subtitle: "The effect of radiotherapy on the transcriptional profile of human cell lines"
author: "Stuart Lee, Lipi Shukla, Ramin Shayan and Matthew Ritchie"
date: "04/07/2017"
output: 
  bookdown::pdf_document2:
    toc: false
    number_sections: false
    #bibliography: "radio.bib"
    #biblio-style: "plain"
...
in 6 different human cell-lines (Normal Human Dermal Fibroblasts, Normal Human 
...
RNA sequencing (100bp single end) was carried out on an Illumina HiSeq machine 
at AGRF in Melbourne. 
...
elist <- estimateDisp(elist, 
                      design = model.matrix(~ 0 + elist$samples$group),
                      robust=TRUE)
...
```{r de-figs, fig.cap="(ref:de)", out.height = "6cm", fig.show="hold"}
